  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li>
                        <a href="favorite.php"><i class="fa fa-star" aria-hidden="true"></i> My Favorite Books</a>
                    </li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="settinges.php" class="btn btn-default btn-flat"> Settings</a>
                    </div>
                    <div class="pull-right">
                     <!-- <a href="index.php"  class="btn btn-default btn-flat"> Sign out</a>-->
                     <form action="logout.php" method="post" id="regform" role="form">
...
$query = "SELECT * from book_c inner join book on book_c.id_book=book.id_b where book_c.category_code=1";
//
...
$donnees2 = $reponse2->fetch();
          ...
          <div class="thumbnail">
                                     <a href="book_m.php?id= '.$donnees['id_b'].'"> <h3 class="txth3"> '. $donnees['title'].' </h3></a>
              <div class="container">
                <div class="row">

            <a href="book_m.php?id= '.$donnees['id_b'].'" class="image"><img src="img/'. $donnees['pic_b'].'" class="pic"></a>
...
$donnees2 = $reponse2->fetch();
           ...
           echo '<div class="left1">
              <a href="testcmpt.php?id= '.$donnees['id_b'].'"> <img src="img/'. $donnees['pic_b'].'" class="imag"></a>
             </div>
            <div class="right1">
