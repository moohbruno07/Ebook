...
<center><h1><?php  echo $_GET['name']; ?></h1></center> 

      
<form action="command.php?id=<?php echo $_GET['id']; ?>" method="post" id="regform" role="form">

<div class="col-xs-6 separate">

    <center><img src="img/<?php  echo $_GET['id']; ?>" class="admin-pic1" /></center>
  ...
  <textarea name="aderesse" placeholder=" Delivery Aderesse " class="form-control" maxlength="200"></textarea>
        ...
        <div class="inner-wrap">
  <div class="price"><?php $price=$_GET['price']; echo$price; ?> </div>
